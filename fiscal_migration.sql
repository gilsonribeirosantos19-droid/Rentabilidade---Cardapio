...
-- Equivalente à "Tabela de Preços" do TOTVS
-- Salvo uma vez e reutilizado em todas as NF-e futuras do mesmo fornecedor
...
CREATE TABLE IF NOT EXISTS nfe_itens (
  ...
  valor_total             numeric(12,2) NOT NULL DEFAULT 0,
  vinculacao_id           uuid REFERENCES fornecedor_produto_vinculado(id) ON DELETE SET NULL,
  created_at              timestamptz NOT NULL DEFAULT now()
);
