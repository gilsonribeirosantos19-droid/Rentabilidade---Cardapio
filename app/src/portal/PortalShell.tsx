...
type TabKey = 'inventario' | 'solicitacao' | 'perdas' | 'estoque' | 'pcp-porcionamento' | 'pcp-producao'
const LABEL: Record<TabKey, string> = { inventario: 'Inventário', solicitacao: 'Solicitação de Compra', perdas: 'Perdas', estoque: 'Estoque', 'pcp-porcionamento': 'Ordem de Porcionamento', 'pcp-producao': 'Ordem de Produção' }
    ...
    <div className="portal">
      ...
      <div className="p-main">
        ...
        <div className="p-content">
          {tab === 'inventario' ? <PortalInventario /> : tab === 'solicitacao' ? <PortalSolicitacao /> : tab === 'perdas' ? <PortalPerdas /> : tab === 'estoque' ? <PortalEstoque /> : tab === 'pcp-porcionamento' ? <PortalPcp view="porcionamento" /> : tab === 'pcp-producao' ? <PortalPcp view="producao" /> : (
