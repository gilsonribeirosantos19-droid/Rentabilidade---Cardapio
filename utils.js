...
if(typeof document !== 'undefined'){
  ...
  _ssStyle.textContent = '.ss-wrap{position:relative}.ss-btn{width:100%;background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:9px 12px;font-size:13px;color:#0f172a;text-align:left;cursor:pointer;font-family:inherit;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ss-btn:hover{border-color:#2563eb}.ss-btn.ss-ph{color:#94a3b8}.ss-drop{display:none;position:absolute;top:100%;left:0;right:0;background:#fff;border:1px solid #e2e8f0;border-radius:8px;box-shadow:0 8px 24px rgba(0,0,0,.14);z-index:1000;margin-top:4px;overflow:hidden}.ss-drop.open{display:block}.ss-search{width:100%;border:none;border-bottom:1px solid #e2e8f0;padding:9px 12px;font-size:13px;outline:none;font-family:inherit}.ss-list{max-height:230px;overflow-y:auto}.ss-opt{padding:8px 12px;font-size:13px;cursor:pointer;color:#0f172a;border-bottom:1px solid #f5f7fa}.ss-opt:hover{background:#eff6ff}.ss-opt.sel{background:#2563eb;color:#fff;font-weight:600}.ss-empty{padding:10px 12px;color:#94a3b8;font-size:12px}';
